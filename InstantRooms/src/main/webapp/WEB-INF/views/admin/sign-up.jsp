        ...
        <div class="RoomDetails">
            ...
            <form action="/saveRoom" id="details" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group form-button">
                   ...
                   <div class="form-group form-button" style="margin-bottom:50px">
                    <!-- <div class="btn btn-primary"><a href="/viewrooms"
							class="signup-image-link">View Rooms</a></div>  -->
		<a href="/viewrooms" style="background-color: rgba(250,100,0,0.8);text-decoration:none;padding: 10px;border-radius: 3px;color:#fff; margin-left:120px">View All Rooms</a>
     
        <a href="/home" style="background-color: rgba(250,100,0,0.8);text-decoration:none;padding: 10px;border-radius: 3px;color:#fff; ">Go to Home</a>
                </div>
                </div>
